...
export interface Role {
  ...
  nameFr?: string;
  permissions: {
    users: { read: boolean; create: boolean; update: boolean; delete: boolean; approve: boolean; ban: boolean };
    ...
    boards: { read: boolean; create: boolean; update: boolean; delete: boolean; assignMembers: boolean };
...
export interface Board {
  ...
  members: Array<{ userId: string; nameAr: string; roleId: string; roleNameAr: string; joinedAt: Timestamp }>;
...
export interface Transaction {
  ...
  debits: Array<{ accountId: string; accountType: string; ownerNameAr?: string; amount: number }>;
  credits: Array<{ accountId: string; accountType: string; ownerNameAr?: string; amount: number }>;
  amount: number;
  currency: 'MRU';
  month?: string;
  category?: string;
...
export interface Election {
  ...
  boardId?: string;
  boardNameAr?: string;
  candidates: Array<{ userId: string; nameAr: string; nameFr?: string; bio?: string; photoUrl?: string }>;
  startDate: Timestamp;
  endDate: Timestamp;
...
export interface ElectionResults {
  id: string;
  electionRef: DocumentReference;
  candidateVotes: Array<{ candidateId: string; candidateNameAr: string; voteCount: number; percentage: number }>;
  totalVotes: number;
  invalidVotes: number;
  winnerId?: string;
  winnerNameAr?: string;
...
export interface SyncMetadata {
  ...
  conflictingDocs: Array<{ docId: string; collection: string; conflictType: 'update' | 'delete'; detectedAt: Timestamp }>;
  lastError?: string;
  errorCount: number;
